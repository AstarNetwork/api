...
import type { EraStakingPoints } from '@plasm/types/interfaces/dappsStaking';
import type { Parameters, SmartContract } from '@plasm/types/interfaces/operator';
import type { ChallengeGame, Config, Decision, PredicateContract, Property } from '@plasm/types/interfaces/ovm';
import type { AuthorityVote, Claim, ClaimId, ClaimVote, DollarRate, Lockdrop, TickerRate } from '@plasm/types/interfaces/plasmLockdrop';
import type { AddressInclusionProof, AddressTreeNode, Checkpoint, Exit, ExitDeposit, InclusionProof, IntervalInclusionProof, IntervalTreeNode, Range, RangeOf, StateUpdate } from '@plasm/types/interfaces/plasma';
import type { Offer, OfferOf, OfferState } from '@plasm/types/interfaces/trading';
...
declare module '@polkadot/types/types/registry' {
  export interface InterfaceTypes {
    ...
    'Option<AddressInclusionProof>': Option<AddressInclusionProof>;
    'Option<AddressTreeNode>': Option<AddressTreeNode>;
    ...
    'Option<ChallengeGame>': Option<ChallengeGame>;
    ...
    'Option<ExitDeposit>': Option<ExitDeposit>;
    ...
    'Option<InclusionProof>': Option<InclusionProof>;
    ...
    'Option<IntervalInclusionProof>': Option<IntervalInclusionProof>;
    'Option<IntervalTreeNode>': Option<IntervalTreeNode>;
    ...
    'Option<OfferOf>': Option<OfferOf>;
    'Option<OfferState>': Option<OfferState>;
    ...
    'Option<PredicateContract>': Option<PredicateContract>;
    ...
    'Option<SmartContract>': Option<SmartContract>;
    ...
    'Option<StateUpdate>': Option<StateUpdate>;
    ...
    'Vec<AddressInclusionProof>': Vec<AddressInclusionProof>;
    'Vec<AddressTreeNode>': Vec<AddressTreeNode>;
    ...
    'Vec<Exit>': Vec<Exit>;
    'Vec<ExitDeposit>': Vec<ExitDeposit>;
    ...
    'Vec<InclusionProof>': Vec<InclusionProof>;
    ...
    'Vec<IntervalInclusionProof>': Vec<IntervalInclusionProof>;
    'Vec<IntervalTreeNode>': Vec<IntervalTreeNode>;
    ...
    'Vec<Offer>': Vec<Offer>;
    'Vec<OfferOf>': Vec<OfferOf>;
    'Vec<OfferState>': Vec<OfferState>;
    ...
    'Vec<PredicateContract>': Vec<PredicateContract>;
    ...
    'Vec<SmartContract>': Vec<SmartContract>;
    ...
    AddressTreeNode: AddressTreeNode;
    ...
    PredicateContract: PredicateContract;
